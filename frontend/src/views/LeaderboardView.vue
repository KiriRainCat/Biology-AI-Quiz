...
<template>
  <div class="flex flex-col items-center justify-center">
    ...
    <!-- 排行榜主题 -->
    <div v-else>
      <div class="flex mb-1.5 font-bold">
        <div class="ml-3 mr-[4.2rem]">Name</div>
        <div class="mr-[1.3rem]">Acc.</div>
        <div class="mr-[2.6rem]">Time</div>
        <div>Recorded On</div>
      </div>
      <var-table elevation="0" scroller-height="76vh" class="w-[40rem]">
